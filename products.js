...
const productDisplay = async () => {
  ...
  // On appelle ça pour que le "onclick" existe dans la page display, je pense ;)
  addProduct();
};
productDisplay();
...
const addProduct = () => {
  ...
  button.addEventListener("click", () => {
    ...
    // Donc il faut que 'productsInStorage' soit bien OK à ce niveau
    // (qu'il ait rep^ris les anciens articles dedans + le nouveau)
    ...
    alert(
      "FIN: produit d'id " +
        productDataWithQuantityAndColor._id +
        ", couleur : " +
        productDataWithQuantityAndColor.color +
        ", et en quantité " +
        productDataWithQuantityAndColor.quantity +
        "  ajouté/mis à jour au/dans le panier"
    );
  });
};
